...
TEST_CASE("The parser returns correct tokens", "[parser]")
{
	...
	std::vector<std::string> correct_tokens = {"test_png.png", "--rotate=90", "-hxy", "--insert=23/23#test_ppm.ppm", "--negative"};
...
{
	std::vector<std::string> correct_tokens = {"test_png.png", "--crop=45/45/6/2", "--rotate=32", "--resize=0.2", 
									"--insert=23/23#test_ppm.ppm", "--convert_to=ppm", "-nxyvh"};

	std::vector<std::string> correct_commands= {"crop=45/45/6/2", "rotate=32", "resize=0.2", "insert=23/23#test_ppm.ppm", 
...
{
	std::vector<std::string> correct_tokens = {"test_png.png", "--rotate=90", "-y", "--insert=23/32#test_ppm.ppm", "--crop=45/67/52/90"};
	std::vector<std::string> correct_commands= {"rotate=90", "reflect_y", "insert=23/32#test_ppm.ppm", "crop=45/67/52/90"};
	...
	SECTION("Correct commands", "[parser]") 
	{
		...
		std::vector<std::string> test_param_3 = {"23", "32", "test_ppm.ppm"};
